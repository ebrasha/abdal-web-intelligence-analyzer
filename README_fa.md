...
شما می‌توانید ابزار تحلیل هوشمند وب ابدال را بدون نیاز به نصب وابستگی‌ها، از طریق داکر اجرا کنید:
...
### ▶️ اگر از **ویندوز (Windows)** استفاده می‌کنید:

1. فایل `run.bat` را اجرا کنید. برای این کار می‌توانید روی آن دوبار کلیک کنید یا در ترمینال اجرا نمایید:
```bat
run.bat
```
